...
class WatermarkPage: PDFPage {
    ...
    private static let attributes = [
        ...
        NSAttributedString.Key.foregroundColor:UIColor(red: 0.5, green: 0.5, blue: 0.5, alpha: 0.2)
    ]
    ...
    override func draw(with box: PDFDisplayBox, to context: CGContext) {
        ...
        let titleAttributes = [
            NSAttributedString.Key.font: UIFont(
                ...
                into: watermarkSize,
                with: [
                    NSAttributedString.Key(rawValue: NSAttributedString.Key.font.rawValue): UIFont.boldSystemFont(ofSize: 50),
                ],

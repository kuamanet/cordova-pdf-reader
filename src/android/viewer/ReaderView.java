...
public class ReaderView
    ...
    public void setSelection(int arg0) {
        int not_supportedIdentifier = getResources().getIdentifier("string/not_supportedIdentifier", null, mContext.getPackageName());
        throw new UnsupportedOperationException(getContext().getString(not_supportedIdentifier));
    }
